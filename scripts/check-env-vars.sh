...
SKIP_VARS="NODE_ENV|PORT|HOSTNAME|NEXT_RUNTIME|CI|PLAYWRIGHT_BASE_URL|NEXT_PUBLIC_ENV|NEXT_PUBLIC_CAMERA_MODULE_ENABLED|NEXT_PUBLIC_SENTRY_DSN|SENTRY_AUTH_TOKEN|NEXT_PUBLIC_SUPABASE_URL|NEXT_PUBLIC_SUPABASE_ANON_KEY"
